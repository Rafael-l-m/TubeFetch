...
public:
    ...
    QJsonObject addYoutubeAction(const QJsonObject& obj) const;
    QJsonObject removeDownload(const QJsonObject& obj) const;
    QJsonObject removeAllDownloads() const;
    QJsonObject removeUselessActions(const QJsonObject& obj) const;
    ...
    QJsonObject getWeights(const QJsonObject& obj) const;
};
