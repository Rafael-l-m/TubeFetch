...
private slots:
    ...
    void handleClickButton() {
        ...
        if (inf.suffix().isEmpty()) {
            ...
            if (selectedFilter.contains("*.wav")) {
                qDebug() << "3.2";
                this->su.setFormat("wav");
            }
            ...
            else if (selectedFilter.contains("*.aac")) {
                qDebug() << "3.4";
                this->su.setFormat("aac");
            }

            else if (selectedFilter.contains("*.opus")) {
                qDebug() << "3.5";
                this->su.setFormat("opus");
            }

            else if (selectedFilter.contains("*.flac")) {
                qDebug() << "3.6";
                this->su.setFormat("flac");
            }

            else if (selectedFilter.contains("*.ogg")) {
                qDebug() << "3.7";
                this->su.setFormat("ogg");
            }
